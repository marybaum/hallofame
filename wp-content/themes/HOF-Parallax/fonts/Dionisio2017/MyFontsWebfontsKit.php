...
/*
Plugin Name: MyFontsWebfontsKit #3493901
...
add_action( 'admin_init', array('MyFontsInstaller_3493901','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3493901','mffonts_loadupWebfonts' ));